...
#### **Registry Structure:**
```
registry.terraform.io/geico-private/pkg
├── versions/
│   ├── 0.1.0/
│   │   ├── download/
│   │   │   ├── darwin_amd64/
...
mkdir -p ~/.terraform.d/plugins/geico-private/pkg/0.1.0/darwin_amd64/
unzip terraform-provider-pkg_0.1.0_darwin_amd64.zip -d ~/.terraform.d/plugins/geico-private/pkg/0.1.0/darwin_amd64/
```
...
provider_installation {
  dev_overrides {
    "geico-private/pkg" = "/path/to/terraform-package"
  }
  direct {}
}
```
